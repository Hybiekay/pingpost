...
import 'package:ping_post/common/error_page.dart';
...
import 'package:ping_post/features/tweet/views/twitter_reply_screen.dart';
import 'package:ping_post/features/users_profile/view/user_profile_view.dart';
import 'package:ping_post/features/widgets/carousel_image.dart';
import 'package:ping_post/features/widgets/hashtag_text.dart';
import 'package:ping_post/features/widgets/tweet_icon_button.dart';
...
class TweetCard extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return currentUser == null
        ? const SizedBox()
        : ref
              .watch(userDetailProvider(tweet.uid))
              .when(
                data: (user) {
